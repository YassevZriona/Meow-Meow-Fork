...
public class BlockBase extends Block {
    ...
    public BlockBase(String name, Material soundMaterial, float hardness, float resistance, String harvest, int harvestLevel, CreativeTabs creativeTabs, boolean opaqueCube, boolean FullCube, AxisAlignedBB axisAlignedBB, AxisAlignedBB axisAlignedBB_WE, Boolean underBlockDestructionInverted, ItemStack ItemDrop) {
        super(soundMaterial);
    ...
    public void observedNeighborChange(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) {
        if(!this.canBlockStayBoolean) {
            ...
            InventoryHelper.spawnItemStack(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ItemDrop.getItem()));
        }
    }
