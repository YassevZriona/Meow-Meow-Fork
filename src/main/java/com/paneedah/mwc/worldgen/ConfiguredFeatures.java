...
public class ConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, ALUMINUM_ORE, Feature.ORE, new OreConfiguration(aluminumOre, 6));
        register(context, LEAD_ORE, Feature.ORE, new OreConfiguration(leadOre, 4));
        ...
        register(context, URANIUM_ORE, Feature.ORE, new OreConfiguration(uraniumOre, 4));
        ...
        register(context, NITER_ORE, Feature.ORE, new OreConfiguration(niterOre, 6));
    }
